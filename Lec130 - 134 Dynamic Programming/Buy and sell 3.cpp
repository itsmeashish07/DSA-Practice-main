...
//     int profit = 0;
//     if(buy){
//         profit = max((-prices[index] + solve(index+1,0,prices,limit)),(0+solve(index+1,0,prices,limit)));
//     }else{
//         profit = max((+prices[index] + solve(index + 1, 1,prices,limit)), (0 + solve(index + 1, 0,prices,limit)));
//     }
//     return profit;
// }
...
//     int profit = 0;
//     if(buy){
//         profit = max((-prices[index] + solveMem(index+1,0,prices,dp)),(0+solveMem(index+1,0,prices,dp)));
//     }else{
